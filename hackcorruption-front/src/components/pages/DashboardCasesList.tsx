...
import { deleteCase, listCases } from "../../services/casesService";
...
export default function DashboardCasesList() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteCase(confirmTarget.id);
      setCases((prev) => prev.filter((item) => item.id !== confirmTarget.id));
    } catch (err) {
      console.warn(err);
    } finally {
    ...
    <div className="admin-page">
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">Manage case records, outcomes, and insights.</p>
        </div>
        ...
        <div className="admin-toolbar-left">
          <label className="admin-form-field">
            ...
            <input
              ...
              type="search"
              placeholder="Search id, court, or judge"
              value={search}
                    ...
                    <td>
                      <div className="admin-action-group">
                        <Link
                          ...
                          to={`/dashboard/cases/${encodeURIComponent(item.id)}`}
                        >
                        ...
                        <Link
                          ...
                          to={`/dashboard/cases/${encodeURIComponent(item.id)}/edit`}
                        >
                          <svg viewBox="0 0 24 24" width="14" height="14" fill="none" aria-hidden="true">
                            <path
